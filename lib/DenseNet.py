...
class Old_Densenet(torchvision.models.DenseNet):
    """
     growth_rate: int = 32,
        ...
        memory_efficient: bool = False
    """
    def __init__(self,growth_rate,block_config,num_init_features,bn_size,drop_rate,num_classes,memory_efficient=False):
        super(Old_Densenet,self).__init__(growth_rate,block_config,num_init_features,bn_size,drop_rate,num_classes,memory_efficient)
